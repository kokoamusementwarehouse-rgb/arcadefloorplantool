...
export const persistLayoutMachines = (venueId: string, value: LayoutMachine[]) => write("layout-machines", venueId, value);
...
export const loadGlobalState = () => read<PersistedGlobalState>("transfer-buffers", "global");
export const persistGlobalState = (value: PersistedGlobalState) => write("transfer-buffers", "global", value);
